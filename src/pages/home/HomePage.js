  ...
  return (
    <div className="content bg-[#ffffff] rounded-[6px] mt-[35px]">
      <div id="home" className="home active boxshadow">
        <div className="row">
          <section className="about-me pb-[45px] pt-[44px] px-[30px]">
            <div className="section-title relative inline-block py-0 px-[3px] ">
              ...
              <h2 className="text-[18px] font-[600]">About Me</h2>
            </div>
          ...
          <div className="row">
            <section className="services bg-[#fafafa] py-[45px] px-[30px]">
              <div className="section-title relative inline-block py-0 px-[3px] mb-[45px]">
                <span className="bg-[#ffb100] absolute h-[7px] w-full opacity-[0.4] left-0 bottom-[3px]"></span>
                <h2 className="text-[18px] font-[600]">My Services</h2>
              </div>
          ...
          <div className="row skill flex items-center justify-between skills">
            <section className=" w-full design-skills px-[30px] py-[45px]">
              <div className="section-title relative inline-block py-0 px-[3px] ">
                <span className="bg-[#ffb100] absolute h-[7px] w-full opacity-[0.4] left-0 bottom-[3px]"></span>
                <h2 className="text-[18px] font-[600]">Design Skills</h2>
              </div>
            ...
            <section className=" w-full code-skills px-[30px] py-[45px]">
              <div className="section-title relative inline-block py-0 px-[3px] ">
                <span className="bg-[#ffb100] absolute h-[7px] w-full opacity-[0.4] left-0 bottom-[3px]"></span>
                <h2 className="text-[18px] font-[600]">Code Skills</h2>
              </div>
              <ul className="skill-list">
                <li>
